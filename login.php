					...
					<form action="login_process.php" method="POST" class="loginForm">
						<h3 class="mb-3 text-center ">Login</h3>
					  	<div class="mb-3">
					    	...
					    	<input type="email" name="useremail" value="" class="form-control" placeholder="Enter your email address">
					  	</div>
					  	<div class="mb-3">
						    <label for="exampleInputPassword1" class="form-label">Password</label>
						    <input type="password" name="password" value="" class="form-control" placeholder="Enter your password here">
					  	</div>
					<!--
